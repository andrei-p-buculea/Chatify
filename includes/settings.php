			...
			.dragging{
				border: dashed 2px #aaa;
		 		...
		 		<div style="display:flex;animation: appear 1s ease">
		 			...
		 			<div>
		 			<span style="font-size:11px;">Trageti aici noua imagine de profil</span><br>
					...
					<form id="myform" >
						...
						<div style="padding: 10px;">
							<br>Sex:<br>
							<input type="radio" value="Male" name="gender" '.$gender_male.'> Barbat<br>
							<input type="radio" value="Female" name="gender" '.$gender_female.'> Femeie<br>
						</div>
						...
						<input type="button" value="Salveaza setarile" id="save_settings_button" onclick="collect_data(event)" ><br>
