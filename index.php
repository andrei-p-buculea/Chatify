	...
	<div id="wrapper">
		...
		<div id="left_pannel">
			...
			<div id="user_info" style="padding: 10px;">
				...
				<br>
				<div>
					<label id="label_chat" for="radio_chat">Chat-uri <img src="ui/icons/chat.png"></label>
					<label id="label_contacts" for="radio_contacts">Contacte <img src="ui/icons/contacts.png"></label>
					<label id="label_settings" for="radio_settings">Setari <img src="ui/icons/settings.png"></label>
...
<script type="text/javascript">
	...
	{
		var answer = confirm("Sunteti sigur ca vreti sa iesiti din aplicatie?");
		if(answer){
			get_data({},"logout");
		}
	}
	...
	function send_message(e)
	{
		...
		if(message_text.value.trim() == ""){
			...
			alert("Nu poate fi trimis un mesaj gol");
			return;
		}
	...
	function delete_thread(e)
	{
		...
		if(confirm("Sunteti sigur ca doriti sa stergeti intreaga conversatie?")){
...
<script type="text/javascript">
	...
	function collect_data(){
		...
		save_settings_button.value = "Incarcare...Va rugam asteptati..";
