...
function message_controls()
{
	...
	<span onclick='delete_thread(event)' style='color:purple;cursor:pointer;'>Sterge aceasta conversatie </span>
	<div style='display:flex;width:100%;height:40px;'>
		...
		<input id='message_text' onkeyup='enter_pressed(event)' style='flex:6;border:solid thin #ccc;border-bottom:none;font-size:14px;padding:4px;' type='text' placeHolder='Scrie un mesaj'/>
		<input style='flex:1;cursor:pointer;' type='button' value='trimite' onclick='send_message(event)'/>
	</div>
	</div>";
}
